...
using EmojitClient.Maui.Abstractions.Leaderboard;
using EmojitClient.Maui.Abstractions.Realtime;
using EmojitClient.Maui.Abstractions.Stats;
using EmojitClient.Maui.Options;
using EmojitClient.Maui.Services.Authentication;
using EmojitClient.Maui.Services.Leaderboard;
using EmojitClient.Maui.Services.Realtime;
using EmojitClient.Maui.Services.Stats;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Options;
using System.Net.Http.Headers;

namespace EmojitClient.Maui.DependencyInjection;
